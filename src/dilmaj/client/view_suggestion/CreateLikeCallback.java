...
public class CreateLikeCallback implements AsyncCallback<LikeComposite> {
	private TermSuggestionServiceAsync tsSvc = GWT.create(TermSuggestionService.class);
	ViewSuggestionPanel panel;
	
	public CreateLikeCallback(ViewSuggestionPanel panel) {
		this.panel=panel;
	}
	...
	@Override
	public void onSuccess(LikeComposite result) {
		// TODO Auto-generated method stub

...
public interface DilmajConstants extends Constants {
  ...
  @DefaultStringValue("Dilamj")
  String dilmaj();

  @DefaultStringValue("Personal")
  String personal();

  @DefaultStringValue("Use Case")
  String usecase();
  ...
  @DefaultStringValue("Your Example ...")
  String yourSample();

  @DefaultStringValue("Create Sample")
	String createSample();
	
  @DefaultStringValue("Clear Sample")
	String clearSample();
	
  @DefaultStringValue("Create Comment")
